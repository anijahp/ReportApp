...
for agency in agencies:
   ...
   # Reset the worksheet name to an empty string for all subsequent sheets
    

# Save the workbook to an Excel file
workbook.save('/Users/anijahphillip/Downloads/Security_Awareness_generatedreport.xlsx')